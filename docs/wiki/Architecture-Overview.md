...
> Canonical source: [docs/ARCHITECTURE.md](https://github.com/xjoker/codex-switch/blob/dev/docs/ARCHITECTURE.md).
...
See the [full architecture document](https://github.com/xjoker/codex-switch/blob/dev/docs/ARCHITECTURE.md) for the data-flow diagram, module map, state layout, safety invariants, and release architecture.
